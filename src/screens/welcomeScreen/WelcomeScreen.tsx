...
export const WelcomeScreen = () => {
    ...
    return (
        ...
        <View style={welcomeScreenStyles.container}>
            ...
            <Pressable style={welcomeScreenStyles.button} onPress={() => navigation.navigate('LoginScreen')} >
                <Text style={welcomeScreenStyles.buttonText}>LOGIN AS USER</Text>
            </Pressable>
            <TouchableOpacity style={welcomeScreenStyles.button} onPress={() => navigation.navigate('LoginScreen')}>
