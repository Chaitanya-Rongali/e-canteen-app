  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <SectionList
        ...
        renderItem={({ item, section }) => <MenuItem item={item} handleDelete={handleDelete} sectionTitle={section.title} role={''} />}
        renderSectionHeader={({ section }) => (
          <SectionHeader title={section.title} SetMenuItems={SetMenuItems} menuItems={menuItems} data={section.data} role={''} />
        )}
      />
    </SafeAreaView>
